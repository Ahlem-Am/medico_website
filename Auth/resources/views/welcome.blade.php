...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 " style="max-width: 500px;">
                <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Article Post</h5>
                <h1 class="display-4">Our Latest Medical Article Posts</h1>
            </div>
            <div class="row g-5 ">
                ...
                <div class="col-xl-4 col-lg-6 overflow-hidden" style="height: 100%;">
                    <div class="bg-light rounded overflow-hidden">
                        <img class="img-fluid w-100" src="{{$article->image}}" alt="">
                        <div class="p-4">
                            <a class="h5 d-block mb-2" href="">{{$article->title}}</a>
                            <p class="m-0 mb-2 fw-normal fst-italic  text-muted">{{$article->created_at->format('d/m/y')}}</p>

                            <p class="m-0 mb-2">{{$article->description}}</p>
                        </div>
                        <div class="d-flex justify-content-between border-top p-4 overflow-hidden">
                            <a href="{{route('detail',$article->slug)}}" class="btn center btn-light rounded-pill ">Read more</a>
                        </div>
                    </div>
                </div>
                @endforeach
