...
@if(session('message'))
                ...
                @endif
<form class="jotform-form" action="{{url('store-form')}}" method="post" name="form_230973976460568" id="230973976460568" accept-charset="utf-8" autocomplete="on"><input type="hidden" name="formID" value="230973976460568" /><input type="hidden" id="JWTContainer" value="" /><input type="hidden" id="cardinalOrderNumber" value="" />
@csrf  
